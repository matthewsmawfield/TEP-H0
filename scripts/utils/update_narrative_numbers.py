...
REPLACEMENTS = [
    ...
    ("Spearman $\\rho = 0.634$, $p = 0.0002$; Pearson $r = 0.514$, $p = 0.0043$",
     "Spearman $\\rho = 0.512$, $p = 0.0045$; Pearson $r = 0.465$, $p = 0.0111$"),
    ...
    ("$\\kappa_{\\rm Cep} = (1.10 \\pm 0.62) \\times 10^6$ mag",
     "$\\kappa_{\\rm Cep} = (0.99 \\pm 0.59) \\times 10^6$ mag"),
    ("$\\kappa_{\\rm Cep} = (1.10 \\pm 0.62)\\times10^6$ mag",
     "$\\kappa_{\\rm Cep} = (0.99 \\pm 0.59)\\times10^6$ mag"),
    ...
    ("$(1.10 \\pm 0.12) \\times 10^6$ mag",
     "$(0.99 \\pm 0.12) \\times 10^6$ mag"),  # keep uncertainty unless it changed
    # H0 and tension
    ("$H_0^{\\rm LOOCV} = 67.87 \\pm 1.54$ km/s/Mpc",
     "$H_0^{\\rm LOOCV} = 68.09 \\pm 1.52$ km/s/Mpc"),
    ("$0.29\\sigma$", "$0.43\\sigma$"),
    ("$H_0 = 67.87$ km/s/Mpc (bootstrap mean\n        $67.75 \\pm 1.54$)",
     "$H_0 = 68.09$ km/s/Mpc (bootstrap mean\n        $68.00 \\pm 1.52$)"),
    ("$H_0 = 67.87$ km/s/MPc", "$H_0 = 68.09$ km/s/Mpc"),  # typo-safe
    ("$H_0 = 67.87$ km/s/Mpc", "$H_0 = 68.09$ km/s/Mpc"),
    ("bootstrap mean $67.75 \\pm 1.54$", "bootstrap mean $68.00 \\pm 1.52$"),
    ("bootstrap mean $67.75 \\pm 1.54$", "bootstrap mean $68.00 \\pm 1.52$"),
    ("Planck tension $0.29\\sigma$)", "Planck tension $0.43\\sigma$)"),
    # Results / Discussion / Conclusion older numbers
    ("$r = 0.493$ vs. 0.462", "$r = 0.493$ vs. 0.465"),
    ("$r = 0.493$ vs. 0.462", "$r = 0.493$ vs. 0.465"),
    ("Spearman $\\rho = 0.511$, $p = 0.0046$; $N=29$",
     "Spearman $\\rho = 0.512$, $p = 0.0045$; $N=29$"),
    ("Spearman $\\rho = 0.511$, $p = 0.0046$",
     "Spearman $\\rho = 0.512$, $p = 0.0045$"),
    ("Pearson $r=0.462$, $p=0.0116$", "Pearson $r=0.465$, $p=0.0111$"),
    ("Pearson $r = 0.462$, $p = 0.0116$", "Pearson $r = 0.465$, $p = 0.0111$"),
    ("$68.09 \\pm 1.52$", "$68.13 \\pm 1.49$"),  # careful: this might catch low-sigma mean too
    ...
    ("TEP-corrected H0 = 67.87 km/s/Mpc (0.29 sigma Planck tension, kappa_Cep = 1.10e6 mag)",
     "TEP-corrected H0 = 68.09 km/s/Mpc (0.43 sigma Planck tension, kappa_Cep = 0.99e6 mag)"),
    ...
    ("unified H_0 = 67.87 km/s/Mpc (bootstrap mean 67.75 ± 1.54)",
     "unified H_0 = 68.09 km/s/Mpc (bootstrap mean 68.00 ± 1.52)"),
    ("reducing Planck tension from 5σ to 0.29σ", "reducing Planck tension from 5σ to 0.43σ"),
    ("κ_Cep ≈ 1.10 × 10⁶ mag", "κ_Cep ≈ 0.99 × 10⁶ mag"),
    ("κ_Cep ≈ 1.10 × 10^6 mag", "κ_Cep ≈ 0.99 × 10^6 mag"),
    ("κ_Cep = (1.10 ± 0.62) × 10^6 mag", "κ_Cep = (0.99 ± 0.59) × 10^6 mag"),
    ("κ_Cep = (1.10 ± 0.62) × 10⁶ mag", "κ_Cep = (0.99 ± 0.59) × 10⁶ mag"),
    ("H0^LOOCV = 67.87 ± 1.54 km/s/Mpc", "H0^LOOCV = 68.09 ± 1.52 km/s/Mpc"),
    ("Planck tension of 0.29σ", "Planck tension of 0.43σ"),
    ("in-sample corrected mean is H0 = 67.87 km/s/Mpc", "in-sample corrected mean is H0 = 68.09 km/s/Mpc"),
    ("bootstrap mean 67.75 ± 1.54", "bootstrap mean 68.00 ± 1.52"),
    ("ρ = 0.634, p = 0.0002", "ρ = 0.512, p = 0.0045"),
    ("Pearson r = 0.514, p = 0.0043", "Pearson r = 0.465, p = 0.0111"),
...
PLAIN_REPLACEMENTS = [
    ...
    ("Spearman $\\rho = 0.634$, $p = 0.0002$; Pearson $r = 0.514$, $p = 0.0043$). A median-split stratification at $\\sigma_{\\rm med} \\approx 88$ km/s yields $H_0 = 67.94 \\pm 0.94$ km/s/Mpc (low-$\\sigma$; $N=15$) versus $77.28 \\pm 0.99$ km/s/Mpc (high-$\\sigma$; $N=14$), implying $\\Delta H_0 = 9.34$ km/s/Mpc. The TEP correction yields a unified Hubble constant $H_0^{\\rm TEP} = 67.87$ km/s/Mpc (bootstrap $67.75 \\pm 1.54$), reducing the Planck tension to $0.29\\sigma$. The Observable Response Coefficient is $\\kappa_{\\rm Cep} = (1.10 \\pm 0.62) \\times 10^6$ mag.",
     "Spearman $\\rho = 0.512$, $p = 0.0045$; Pearson $r = 0.465$, $p = 0.0111$). A median-split stratification at $\\sigma_{\\rm med} \\approx 96$ km/s yields $H_0 = 66.26 \\pm 2.10$ km/s/Mpc (low-$\\sigma$; $N=15$) versus $74.12 \\pm 1.30$ km/s/Mpc (high-$\\sigma$; $N=14$), implying $\\Delta H_0 = 7.86$ km/s/Mpc. The TEP correction yields a unified Hubble constant $H_0^{\\rm TEP} = 68.09$ km/s/Mpc (bootstrap $68.00 \\pm 1.52$), reducing the Planck tension to $0.43\\sigma$. The Observable Response Coefficient is $\\kappa_{\\rm Cep} = (0.99 \\pm 0.59) \\times 10^6$ mag."),
]
