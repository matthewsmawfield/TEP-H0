...
def main():
    ...
    metadata = {
        ...
        'Subject': (
            ...
            'Application of the TEP conformal correction with Observable Response Coefficient κ_Cep = (9.6 ± 4.0) × 10⁵ mag '
            'and effective calibrator reference σ_ref = 75.25 km/s yields a unified local Hubble constant '
            'of H0 = 68.37 ± 1.54 km/s/Mpc, corresponding to a Planck tension of 0.60σ. '
            'The anchor-host dichotomy (κ_anchor ≈ 0 vs κ_Cep ≈ 10⁶ mag) is resolved by group halo screening: '
