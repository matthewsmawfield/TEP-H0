...
| 7 | 446 | 17,802 | 1.0618 | 0.0063 | 1.2787 | +0.0031 |
...
The characteristic screening scale $R_s \approx 2{,}646 \pm 182$ AU is not merely a curve-fitting parameter; it represents the first kinematic detection of the Galactic screening floor. As shown in Section 2.1, the TEP characteristic acceleration $g_{\rm TEP} \approx 5 \times 10^{-10}$ m/s$^2$ (Smawfield 2025g) predicts a transition scale $R_s^{\rm pred} \approx 3{,}929$ AU for the transition-bin mass scale. This order-of-magnitude agreement (factor 1.48) is notable given that $g_{\rm TEP}$ is derived from rotation curves of distant galaxies. Including the Galactic external field as an additional screening floor ($\eta=2$) further reduces the discrepancy to a factor of 1.27 ($R_s^{\rm pred} \approx 2{,}778$ AU). The wide-binary anomaly is therefore quantitatively consistent with the cross-scale screening scale of the TEP conformal sector.
